    ...
    prices: [
      {
        ...
        items: [
          ...
          { title: "Мопс", price: "250" },
          { title: "Французский бульдог", price: "250" },
          { title: "Чихуахуа к/ш", price: "250" },
          { title: "Чихуахуа д/ш", price: "300" },
          { title: "Вест-хайленд вайт терьер - стрижка", price: "400" },
          { title: "Вест-хайленд вайт терьер - тримминг", price: "450" },
          { title: "Цвергшнауцер - стрижка", price: "400" },
        ],
      },
      {
        withWarning: true,
      ...
      },
      {
        ...
        items: [
          { title: "Короткошерстные", price: "300" },
          { title: "Короткошерстные - вычесывание", price: "200" },
          { title: "Длинношерстные", price: "350" },
          { title: "Длинношерстные - вычесывание", price: "250" },
        ],
      },
      {
